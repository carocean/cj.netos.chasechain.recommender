...
public class DefaultTrafficPoolPorts implements ITrafficPoolPorts {
    ...
    @Override
    public List<ContentBox> pageContentBoxOfProvider(ISecuritySession securitySession, String pool, String provider, int limit, long offset) throws CircuitException {
        return contentBoxService.pageContentBoxOfProvider(pool, provider, limit, offset);
    }

    @Override
    public List<ContentBoxAssigner> pageContentBoxByAssigner(ISecuritySession securitySession, String provider, int limit, long offset) throws CircuitException {
